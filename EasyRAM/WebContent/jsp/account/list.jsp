...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/account_findAll.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：账户管理 &gt; 账户列表</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD><s:property value="acct_name"/></TD>
													<TD><s:property value="baseDictLevel.dict_item_name"/></TD>
													<TD><s:property value="baseDictLocation.dict_item_name"/></TD>
													<TD><s:property value="baseDictType.dict_item_name"/></TD>
													<TD><s:property value="acct_phone"/></TD>
													<TD><s:property value="acct_serial"/></TD>
													<TD>
													<a href="${pageContext.request.contextPath }/account_edit.action?cust_id=<s:property value="acct_id"/>">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/account_delete.action?cust_id=<s:property value="acct_id"/>">删除</a>
													</TD>
												</TR>
												</s:iterator>
											</TBODY>
